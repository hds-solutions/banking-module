...
mix.options({
    fileLoaderDirs: {
        images: 'banking-module/assets/images',
        fonts: 'banking-module/assets/fonts',
    }
});
...
mix
     ...
     ** *********************** **/
    .js('resources/assets/js/app.js',       'banking-module/assets/js')
    .sass('resources/assets/sass/app.scss', 'banking-module/assets/css')
    .copy('resources/assets/images',        public+'/banking-module/assets/images')
